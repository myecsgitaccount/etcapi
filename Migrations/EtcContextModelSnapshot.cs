...
{
    [DbContext(typeof(EtcContext))]
    partial class EtcContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EtcLibrary.API.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EtcLibrary.API.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EtcLibrary.API.Entities.Course", b =>
                {
                    b.HasOne("EtcLibrary.API.Entities.Author", "Author")
                        .WithMany("Courses")
